...
export const DAILY_PROTOCOL = [
  { id: 'dp1', name: 'Morning Stack (Creatine, Vitamin D, Omega-3)', emoji: '💊' },
  { id: 'dp2', name: 'Pre-workout Meal (High Protein)',               emoji: '🥩' },
  { id: 'dp3', name: 'Hydration Goal (1 gallon water)',               emoji: '💧' },
  { id: 'dp4', name: 'Post-workout Protein (50g+)',                   emoji: '🥛' },
  { id: 'dp5', name: 'Nighttime Stack (ZMA, Magnesium)',              emoji: '🌙' },
];

// daysRestricted uses JS getDay(): 0=Sun 1=Mon 2=Tue 3=Wed 4=Thu 5=Fri 6=Sat
export const WEEKLY_HABITS = [
  ...
  { id: 'wh3', name: 'Stretch / Mobility',        daysRestricted: null },
